...
struct SettingsView: View {
    ...
    @AppStorage("campgroundlog_showNotes") private var showNotes: Bool = true
    @AppStorage("campgroundlog_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/campground-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/campground-app/terms.html")!)
